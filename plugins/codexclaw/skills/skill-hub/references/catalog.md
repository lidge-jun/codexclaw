...
| qa | `skills/qa/SKILL.md` | capability | manual surface-driving QA after building/changing a user-facing surface (web/TUI/CLI/API/desktop): evidence matrix, adversarial classes, teardown receipts | false | none (rides native browser/CU tools + `.codexclaw/evidence/`) |

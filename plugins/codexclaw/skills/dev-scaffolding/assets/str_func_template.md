...
- [ ] The repo's module-structure doc for this feature (or create one only if the repo already uses that convention)
- [ ] Any index/table-of-contents file that tracks module docs
- [ ] Other files that must stay in sync

...
} from "./approval-relay.js";
import { QueueClosedError, SerialQueues, QueueFullError } from "./queue.js";
import { runTurn, terminateChild,                                   } from "./runner.js";
...
export class AgentService {
  ...
  constructor(opts                     ) {
    ...
    this.approvals = opts.approvalStore ?? createApprovalStore();
          ...
          registerChild(bindingId        , child              )               {
    this.children.add(child);
    const children = this.childrenByBinding.get(bindingId) ?? new Set              ();
    children.add(child);

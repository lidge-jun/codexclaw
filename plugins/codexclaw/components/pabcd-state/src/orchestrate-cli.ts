...
import { advanceWorkPhase, appendGoalplanLedger, readGoalplan, writeGoalplan } from "./goalplan.ts";
...
export function parseOrchestrateCliArgs(argv: string[], cwd: string): OrchestrateCliArgs | CliParseError {
...
export function runOrchestrateCli(args: OrchestrateCliArgs): CliResult {

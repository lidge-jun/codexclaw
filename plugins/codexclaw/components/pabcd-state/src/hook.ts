...
const PHASE_DIRECTIVES: Partial<Record<Phase, string>> = {
  ...
  A: [
    ...
    "task_name. Name every required skill in the spawn message with plugin-native",
    ...
    "spawn-attach hook only normalizes broken/bare cxc mentions to resolvable form; the",
    "dispatcher still names every skill. Ask",

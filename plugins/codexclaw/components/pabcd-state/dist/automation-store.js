...
export function isSafeAutomationId(value         )                  {
  return typeof value === "string" && SAFE_ID.test(value);
}

function invalid()        { throw new Error("unsupported automation store"); }

/** Consume a complete string before looking for another key. Never scan prompt lines as TOML. */
function stringValue(text        , start        , key        )                                 {
 ...
 */
export function readAutomationOwnership(codexHome        , id        )                              {

 ...
 * allows.
*/
import { clearAttempts, hasValidReceipt } from "./subagent-evidence.js";
import { appendLedger, isCanonicalSessionId, readState, withSessionLock, writeState } from "./state.js";
...
export function parseEvidenceCliArgs(argv          , cwd        )                                          {
  const verb = argv[0];
  if (verb !== "resolve") {

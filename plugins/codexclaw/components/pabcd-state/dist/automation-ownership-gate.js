...
import { isSafeAutomationId, readAutomationOwnership,                                  } from "./automation-store.js";
...
export const AUTOMATION_UPDATE_TOOL_NAMES                      = new Set([
 ...
 */
export function handleAutomationOwnershipGate(raw        , deps                     = {})         {
  try {

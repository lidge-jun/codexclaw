 ...
 */
export function isWslRuntime(deps          = {})          {
 ...
 */
export function automountRoot(deps          = {})         {
 ...
 */
export function isWindowsInteropDir(dir        , root = "/mnt")          {
 ...
 */
export function windowsHomeToWslPath(value        , root = "/mnt")                {
 ...
 */
export function filesystemTier(path        , deps          = {})                 {

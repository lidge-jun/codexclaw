...
const UNRESOLVED_CARD = `[codexclaw] Subagent dispatch: family unresolved at SessionStart; managed fallback first; swap the probe for the task. First Code Mode cell (resolves and calls):

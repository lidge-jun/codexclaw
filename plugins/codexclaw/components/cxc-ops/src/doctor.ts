...
export interface DoctorOptions {
  codexHome?: string;
  pluginKey?: string;
  /** Native session filter; null explicitly requests an unverified report. */
...
export function runHookExecutionCheck(pluginRoot: string, options: DoctorOptions = {}): CheckResult {
